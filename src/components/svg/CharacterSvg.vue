...
onMounted(() => {
  ...
  if (savedHairstyleType !== null && savedHairstyleColor !== null) {
    // 使用保存的值
    hairstyleType.value = parseInt(savedHairstyleType);
...
const getHairstylePath = computed(() => {
  ...
  if (hairstyleType.value === 0) {
    // 凌乱短发 - 线条风格
    if (isFacingDown.value) return "M25,15 C35,10 45,10 55,15";
    if (isFacingUp.value) return "M25,15 C35,10 45,10 55,15";
    if (isFacingRight.value) return "M25,15 C35,10 45,10 55,15";
    return "M25,15 C35,10 45,10 55,15";
  } 
  else if (hairstyleType.value === 1) {
    // 卷发 - 线条风格
    if (isFacingDown.value) return "M25,15 C30,7 35,3 40,3 C50,7 55,13 55,15";
    if (isFacingUp.value) return "M25,15 C30,7 35,3 40,3 C50,7 55,13 55,15";
    if (isFacingRight.value) return "M25,15 C30,7 35,3 40,3 C50,7 55,13 55,15";
    return "M25,15 C30,7 35,3 40,3 C50,7 55,13 55,15";
  }
  else if (hairstyleType.value === 2) {
    // 长直发 - 线条风格
    if (isFacingDown.value) return "M25,15 L30,5 L40,2 L50,5 L55,15";
    if (isFacingUp.value) return "M25,15 L30,5 L40,2 L50,5 L55,15";
    if (isFacingRight.value) return "M25,15 L30,5 L40,2 L50,5 L55,15";
    return "M25,15 L30,5 L40,2 L50,5 L55,15";
  }
  else if (hairstyleType.value === 3) {
    // 尖刺发 - 线条风格
    if (isFacingDown.value) return "M25,15 L28,3 L35,10 L40,1 L45,10 L52,3 L55,15";
    if (isFacingUp.value) return "M25,15 L28,3 L35,10 L40,1 L45,10 L52,3 L55,15";
    if (isFacingRight.value) return "M25,15 L28,3 L35,10 L40,1 L45,10 L52,3 L55,15";
    return "M25,15 L28,3 L35,10 L40,1 L45,10 L52,3 L55,15";
  }
  else {
    // 莫霍克发型 - 线条风格
    if (isFacingDown.value) return "M35,15 L40,1 L45,15";
    if (isFacingUp.value) return "M35,15 L40,1 L45,15";
    if (isFacingRight.value) return "M35,15 L40,1 L45,15";
